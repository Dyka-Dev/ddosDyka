...
def helptext ():
        ...
        print "WARNING: SEBELUM MENGGUNAKAN TOOLS INI KALIAN WAJIB NYALAKAN VPN!"
        print "===============COMMAND=============="
        print "   -t How much attack do you want to send"
        print "   -c How much bot/threads do you want to send"
        print "   -p (port)"
        print "JANGAN SHARE JANGAN JUAL ANJING!"
        print "===============DIBACA==============="
        print "JANGAN ABUSE ASU!"
        print "2 DETIK AUTO SUSPEND"
        print "TOOLS BY NCT DYKA"
        print "============DIBACA COEG================"
        print " HANYA UNTUK MEMBER/LEADER NCT "
        print "VPS AUTO SUSPEND"
